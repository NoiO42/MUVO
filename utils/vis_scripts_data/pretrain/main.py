...
def filter_data(task, threshold=50000):
...
file_paths = [
    '100k_val_imagine2_chamfer_distance.json',
    '100k_val_imagine2_psnr.json',
    'occ_val_imagine2_chamfer_distance.json',
    'occ_val_imagine2_psnr.json'
]
...
task_names = ["Lidar-Camera", "50k pretrained Lidar-Camera-Occ"]
...
subplot_width = 1.625  # 6.875 inches divided by 4 subplots
...
plot_data(axs[0], task_data_3)
plot_data(axs[1], task_data_4)
